...
public partial class SimpleAnimationPlayable : PlayableBehaviour
{
    ...
    {
        LinkedListNode<QueuedState> it = m_StateQueue.First;
        while (it != null)
        {
            LinkedListNode<QueuedState> next = it.Next;
    ...
    {
        using (LinkedList<QueuedState>.Enumerator it = m_StateQueue.GetEnumerator())
        {
            while (it.MoveNext())
            {
